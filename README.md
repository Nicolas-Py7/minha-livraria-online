...
Uma aplicação web de e-commerce para venda de livros, desenvolvida com foco em usabilidade, desempenho e experiência do usuário.
...
* **Outros:** (ex: Docker, Stripe API, Firebase)
